    ...
    <div class="navbar-header">
      ...
      <div class="d-flex">
        ...
        >
          ...
          <!-- item-->
          <b-dropdown-item
            @click="$router.push({ name: 'app-data-user', params: { id:idWorker }})"
          >
            <span>
              <i class="bx bx-user font-size-16 align-middle me-1"></i>
              Perfil
            </span>
            <!-- <router-link to="/datos_usuario/0" v-slot="{ navigate }" custom>
...
export default {
  setup() {
    ...
    const idWorker = ref(0)
    idWorker.value = (userData.value.idWorker !== null) ? userData.value.idWorker: 0

    const datosUsuario = () => {
      router.push({ name: 'app-data-user', params: {id: idWorker.value }})
    }
