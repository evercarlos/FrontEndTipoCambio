...
export default [
  {
    ...
    //component: () => import("./views/softsalud/timetable/timetableList"),
  },
  {
    path: "/login",
    name: "login",
  ...
  /* {
    ...
    component: () => import("./views/softsalud/dashboards/index"),
  }, */
  {
    path: "/perfil",
    name: "Perfil",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/profile/profileList"),
  },
  {
    path: "/usuario",
    name: "usuario",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/user/userList"),
  },
  {
    path: "/moneda",
    name: "moneda",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/moneda/monedaList"),
  },
  {
    path: "/tipo_cambio",
    name: "TipoCambio",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/tipoCambio/tipoCambioList"),
  },
  {
    path: "/conversion",
    name: "Conversion",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/conversion/conversionList"),
  },
  /* {
    path: "/perfil",
    name: "Seguridad",
  ...
  },
  {
    ...
    name: "Servicio",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/service/serviceList"),
  },
  {
    path: "/tipo_recurso",
    name: "Tipo Recurso",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/typeResource/typeResourceList"),
  },
  {
    path: "/permisos",
    name: "Permisos",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/permission/permissionList"),
  },
  {
    path: "/contrato",
    name: "Contrato",
    meta: { authRequired: true },
    component: () => import("./views/softseguridad/contract/contractList"),
  },
  {
    path: "/usuario",
    name: "Usuario",
  ...
  /*{
    ...
    name: "Indicación",
    meta: { authRequired: true },
    component: () => import("./views/softtramite/indication/IndicationList"),
  },
  {
    path: "/tipo_documento_tramite",
    name: "tipo_documento_tramite",
    meta: { authRequired: true },
    component: () => import("./views/softtramite/documentType/documentTypeList"),
  },
  {
    path: "/datos_usuario/:id",
    name: "app-data-user",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/user_profile/WorkerForm"),
  },
  {
    path: "/trabajadores",
    name: "app-worker",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/worker/WorkerList"),
  },
  {
    path: '/app-worker-form/:id',
    name: 'app-worker-form',
    component: () => import('./views/softadministracion/worker/WorkerForm.vue'),
  },
  {
    path: "/dependencia",
    name: "app-dependencia",
    meta: { authRequired: true },
    component: () => import("./views/softadministracion/dependence/ExecutorList.vue"),
  },
  {
    path: "/registros",
    name: "app-registros",
    meta: { authRequired: true },
    component: () => import("./views/softtramite/register/inbox.vue"),
  }, */
  /*{
    path: "/recurso",
    name: "Recursos",
    meta: { authRequired: true },
    component: () => import("./views/softsalud/doctor/doctorList"),
  }, */
  {
